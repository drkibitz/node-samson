...
module.exports = (function (dot, TemplateSettings) {
    ...
    // Instance properties
    Object.defineProperties(Template.prototype, /** @lends Template# */ {
        /** @private */
        _type : {value : 'txt'},
        /**
         ...
         * invoking {@link Template#process}.
         * @type {int}
         * @default null
         * @since 1.0
         */
         ...
         */
        process : {
            value : function process(data, vars, thisObj) {
    ...
    // Module provides
    return Object.defineProperties(Template, /** @lends Template */ {
