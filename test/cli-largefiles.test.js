...
var vows = require('vows'),
    ...
    testOutPath = 'test-in/largefile2.txt';
    ...
    "spawn ../bin.js": {
        ...
        "on exit": {
            ...
            "stdout 'files: #' matches": {
                ...
                "[1] is equal to 2": function (matches) {
                    assert.strictEqual(parseInt(matches[1]), 2);
                }
            },
            "testing output file": {
                topic: function () {
                ...
                "after a successful 'fs.stat'": {
                    ...
                    "after a successful 'fs.open'": {
                        ...
                        // "'fs.read' contents length is 4663298": function (data) {
                        //  assert.strictEqual(data.length, 4663298);
                        // },
