...
module.exports = (function (path, EventEmitter, WriteStream, mkdirp, Queue) {
    ...
    ResourceWriter.prototype = Object.freeze(Object.create(EventEmitter.prototype, /** @lends ResourceWriter# */ {
        ...
        /**
         * Retreive an instance of {@link fs.WriteSteam} by the file
         ...
         * callback, this method is able to retreive the filtered or new file path, by
        ...
        /**
         * When using the {@link module:node-samson/lib/ResourceWriter#filterFilePath}
         * callback, this method is able to retreive the unfiltered or original file
